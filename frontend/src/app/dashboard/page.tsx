...
const LINE_DATA_POSTS = [40, 58, 45, 72, 65, 88, 74, 105, 92, 118, 98, 140];
const LINE_DATA_ENGAGEMENT = [55, 62, 48, 70, 80, 75, 90, 85, 95, 88, 102, 110];
const BAR_DATA_HOURS = [5, 8, 12, 18, 25, 30, 42, 55, 60, 58, 50, 45, 40, 38, 42, 50, 60, 65, 58, 45, 32, 20, 12, 7];
const BAR_DATA_TOPICS = [88, 62, 45, 72, 55, 38, 30];
const TOPIC_LABELS = ['AI', 'Gaming', 'Politics', 'Science', 'Business', 'Education', 'News'];
